<template>
  ...
  >
    ...
    <!-- <FilterCard model = 'bla' label="Hmm!" >
      <StringFilter name="Search" v-model="search"></StringFilter>
<CheckboxFilter
...
import { StringFilter, MultiFilter, NumberFilter, RangeFilter, DateTimeFilter, ActiveFilters, ChangeFilters } from '@molgenis-ui/components-library'
/** */
